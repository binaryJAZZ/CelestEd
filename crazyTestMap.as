/**
 * Initialization code: new crazyTestMap(new FlxPoint(2176, 2176),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class crazyTestMap extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function crazyTestMap(levelSize:FlxPoint, blockSize:FlxPoint):void {
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new crazyTestMap(new FlxPoint(2176, 2176),new FlxPoint(16, 16));
			}
			else
			{
				return null;
