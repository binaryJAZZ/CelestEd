/**
 * Initialization code: new __SAVEPOINT__TEST7__(new FlxPoint(448, 352),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class __SAVEPOINT__TEST7__ extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function __SAVEPOINT__TEST7__(levelSize:FlxPoint, blockSize:FlxPoint):void {
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new __SAVEPOINT__TEST7__(new FlxPoint(448, 352),new FlxPoint(16, 16));
			}
			else
			{
				return null;
