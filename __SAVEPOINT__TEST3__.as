/**
 * Initialization code: new __SAVEPOINT__TEST3__(new FlxPoint(448, 352),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class __SAVEPOINT__TEST3__ extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function __SAVEPOINT__TEST3__(levelSize:FlxPoint, blockSize:FlxPoint):void {
		...
		override protected function savePointCreation():void{
			...
			savePoints.push(new SavePoint(64.5, 33.5));
		}
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new __SAVEPOINT__TEST3__(new FlxPoint(448, 352),new FlxPoint(16, 16));
			}
			else
			{
				return null;
