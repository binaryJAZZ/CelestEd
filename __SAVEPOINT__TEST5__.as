/**
 * Initialization code: new __SAVEPOINT__TEST5__(new FlxPoint(448, 352),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class __SAVEPOINT__TEST5__ extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function __SAVEPOINT__TEST5__(levelSize:FlxPoint, blockSize:FlxPoint):void {
		...
		override protected function savePointCreation():void{
			...
			savePoints.push(new SavePoint(40.0, 40.0));
			savePoints.push(new SavePoint(72.0, 56.5));
			savePoints.push(new SavePoint(120.5, 89.5));
		}
		...
		override protected function addEnemies(): void {
			...
			waypointList2.push(new FlxPoint(24.0,152.0)); 
			waypointList2.push(new FlxPoint(56.0,152.0)); 
			waypointList2.push(new FlxPoint(104.0,152.0)); 
			...
			var enemy2:Enemy = new Enemy(Assets.GUARD_SPRITE, waypointList2, player, enemyLight, 16.0, 144.0); 
			enemies.push(enemy2); 
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new __SAVEPOINT__TEST5__(new FlxPoint(448, 352),new FlxPoint(16, 16));
			}
			else
			{
				return null;
