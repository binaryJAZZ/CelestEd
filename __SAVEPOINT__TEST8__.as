/**
 * Initialization code: new __SAVEPOINT__TEST8__(new FlxPoint(448, 352),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class __SAVEPOINT__TEST8__ extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function __SAVEPOINT__TEST8__(levelSize:FlxPoint, blockSize:FlxPoint):void {
		...
		override protected function savePointCreation():void{
			...
			savePoints.push(new SavePoint(24.0, 24.0));
			savePoints.push(new SavePoint(56.5, 41.0));
			savePoints.push(new SavePoint(96.0, 17.5));
		}
		...
		override protected function addEnemies(): void {
			...
			waypointList1.push(new FlxPoint(24.0,152.0)); 
			waypointList1.push(new FlxPoint(56.0,152.0)); 
			waypointList1.push(new FlxPoint(104.0,152.0)); 
			...
			var enemy1:Enemy = new Enemy(Assets.GUARD_SPRITE, waypointList1, player, enemyLight, 16.0, 144.0); 
			enemies.push(enemy1); 
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new __SAVEPOINT__TEST8__(new FlxPoint(448, 352),new FlxPoint(16, 16));
			}
			else
			{
				return null;
