/**
 * Initialization code: new Dec9_test1(new FlxPoint(384, 256),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class Dec9_test1 extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function Dec9_test1(levelSize:FlxPoint, blockSize:FlxPoint):void {
			super(levelSize, blockSize, new FlxPoint(88.0,24.0));
		...
		override protected function addHideableObjects():void {
			...
			hideableObjects.push(new HideableObject(107.0,106.5,Assets.WalrusArmor));
			hideableObjects.push(new HideableObject(45.0,107.5,Assets.WalrusArmor,true,0.5));
		}

		override protected function savePointCreation():void{
			super.savePointCreation();
			savePoints.push(new SavePoint(168.0, 8.0));
		}
		...
		override protected function createMap():void {
			...
			tiles.loadMap(
				FlxTilemap.arrayToCSV(FLOORS, 12),
			...
			tiles = new FlxTilemap();
			tiles.loadMap(
				FlxTilemap.arrayToCSV(WALLS, 12),
			...
			tiles = new FlxTilemap();
			tiles.loadMap(
				FlxTilemap.arrayToCSV(FOREGROUND, 12),
				Assets.celesteTileset, tileSize.x, tileSize.y
			);
		...
		protected function createObjects():void {
			...
			sprite = new FlxSprite(69.0,103.5,Assets.WalrusArmor);
		...
		override protected function createWaterDroplets():void {
			...
			waterDrop = new FlxSprite(24.0, 40.0, Assets.WATER_DROP);
			waterDrops.push(waterDrop);

			waterDrop = new FlxSprite(24.0, 88.0, Assets.WATER_DROP);
			waterDrops.push(waterDrop);
		...
		override protected function addEnemies(): void {
			...
			waypointList0.push(new FlxPoint(184.0,72.0)); 
			waypointList0.push(new FlxPoint(184.0,120.0)); 
			waypointList0.push(new FlxPoint(88.0,120.0)); 
			waypointList0.push(new FlxPoint(168.0,120.0)); 
			waypointList0.push(new FlxPoint(168.0,72.0)); 
			...
			var enemy0:Enemy = new Enemy(Assets.GUARD_SPRITE, waypointList0, player, enemyLight, 176.0, 64.0); 
			enemies.push(enemy0); 
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new Dec9_test1(new FlxPoint(384, 256),new FlxPoint(16, 16));
			}
			else
			{
				return null;
