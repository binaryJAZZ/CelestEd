/**
 * Initialization code: new __SAVEPOINT__TEST4__(new FlxPoint(448, 352),new FlxPoint(16, 16));
 * tilesize: 16
 */
package
{
	import org.flixel.*;
	public class __SAVEPOINT__TEST4__ extends TopDownLevel
	{
		/** 
		 * FLOORS layer 
		...
		public function __SAVEPOINT__TEST4__(levelSize:FlxPoint, blockSize:FlxPoint):void {
		...
		override protected function savePointCreation():void{
			...
			savePoints.push(new SavePoint(32.0, 32.0));
			savePoints.push(new SavePoint(64.0, 48.5));
		}
		...
		override protected function addEnemies(): void {
			...
			waypointList0.push(new FlxPoint(24.0,152.0)); 
			waypointList0.push(new FlxPoint(56.0,152.0)); 
			waypointList0.push(new FlxPoint(104.0,152.0)); 
			...
			var enemy0:Enemy = new Enemy(Assets.GUARD_SPRITE, waypointList0, player, enemyLight, 16.0, 144.0); 
			enemies.push(enemy0); 
		...
		override public function transferLevel(): TopDownLevel{
			...
			{
				return new __SAVEPOINT__TEST4__(new FlxPoint(448, 352),new FlxPoint(16, 16));
			}
			else
			{
				return null;
